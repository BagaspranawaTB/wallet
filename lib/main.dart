...
import 'package:wallet/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<WalletFirebaseUser> userStream;
  WalletFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = walletFirebaseUserStream()
